...
for (K in MINID:MAXID) 
{
	...
	path_img1 <-sprintf("Compact/%dc.bmp", K)
	path_img2 <-sprintf("Not Compact/%ds.bmp", K)
	...
	jpeg(sprintf("%s.out.jpeg", path_img1))
		...
		plot(0:(ncol-1), type='n', main="", xlab=" ", ylab=" ",xlim=c(0,ncol-1),ylim=c(nrow-1,0),  xaxt='n',yaxt='n',cex.main=2.0, cex.lab=2.0, cex.axis=2.0)
		rasterImage(img1/255.0, 0, nrow-1, ncol-1, 0)
		grid()
		title(xlab="X(pixels)", line=1, cex.lab=2.0, family="Calibri Light")
		title(ylab="Y(pixels)", line=1, cex.lab=2.0, family="Calibri Light")
	...
	jpeg(sprintf("%s.out.jpeg", path_img2))
		...
		grid()
		title(xlab="X(pixels)", line=1, cex.lab=2.0, family="Calibri Light")
		title(ylab="Y(pixels)", line=0, cex.lab=2.0, family="Calibri Light")
